...
export default function GuestDashboard() {
  ...
  const guestId = "guest1"; // In a real app, this would come from auth

  const { data: bookings = [] } = useQuery<Booking[]>({
    queryKey: ["/api/bookings/guest", guestId],
  });

  const { data: deliveryOrders = [] } = useQuery<DeliveryOrder[]>({
    queryKey: ["/api/delivery-orders/guest", guestId],
  });
                        ...
                        <CardContent className="p-6">
                          <div className="flex justify-between items-start">
                            ...
                            <div className="text-right">
                              ...
                              <Button 
                                size="sm" 
                                className="mt-2 bg-perra-gold hover:bg-perra-gold/90"
            ...
            {bookings.length === 0 && (
              <Card>
                <CardContent className="py-12 text-center">
                  ...
                  <p className="text-perra-gray mb-4">Start exploring amazing properties for your next extended stay</p>
                  <Button 
            ...
            <Card>
              <CardContent className="p-6">
                <div className="text-center py-12">
                  <p className="text-perra-gray">Profile settings will be available in a future update.</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
